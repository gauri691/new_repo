...
class Library {
    ...
    private Library() {
        items = new HashMap<>();
        Books book1 = new Books("The Great Gatsby", "F. Scott Fitzgerald", true, 101, 2);
        Books book2 = new Books("To Kill a Mockingbird", "Harper Lee", true, 102, 3);
    ...
    public void addBook(Books book) {
        if (count < maxLength) {
            ...
            items.put(book, book.getNumberOfCopies());
